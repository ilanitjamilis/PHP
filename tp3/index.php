<html>
	...
	<body>
		...
		<form action="funciones.php" method="POST" id="formPrincipal"> 
			...
			<label id="errorApellido"></label></br></br>
			
			<label for="mail">Email:</label>
			<input type="text" name="email" value="" id="mail"/>
			<label id="errorMail"></label></br></br>
